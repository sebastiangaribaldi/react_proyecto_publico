...
const ProductosElectronica = ({ agregarProducto }) => {
  ...
  const prodCat = productos.filter((producto, indice) => producto.category.includes('electronics'))
...
export default ProductosElectronica;
